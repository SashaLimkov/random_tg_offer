...
class TelegramUser(TimeBasedModel):
    ...
    user_id = models.BigIntegerField(
        unique=True, verbose_name="UserID"
    )
...
class UserQuestion(TimeBasedModel):
    ...
    helper_id = models.BigIntegerField(unique=False, verbose_name="ID Отвечающего", default=0)
    question = models.CharField(max_length=5000, verbose_name="Вопрос")
    history = models.CharField(max_length=10000, verbose_name="История вопроса", null=True)
